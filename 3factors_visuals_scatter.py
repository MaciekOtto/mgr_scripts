...
# Ustawienie stylu wykresów (styl akademicki)
sns.set_theme(style="whitegrid")
plt.rcParams.update({'font.size': 12})

# 1. Wczytanie danych (upewnij się, że nazwa pliku jest poprawna)
df = pd.read_excel('ff3_regresja_przekrojowa_vis.xlsx')

# 2. Utworzenie siatki wykresów (2 wiersze, 2 kolumny)
...
# Poprawa układu i zapisanie wykresu
plt.tight_layout()
